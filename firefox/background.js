/**
 * Nasaq — Background Script (Firefox version)
 * يستخدم sidebar_action بدل sidePanel للتوافق مع Firefox
 */
...
// النقر على أيقونة الإضافة يفتح/يغلق الـ sidebar (في Firefox)
...
chrome.commands.onCommand.addListener(async (command) => {
  ...
  // _execute_sidebar_action مُعالج تلقائيًا بواسطة Firefox
});
